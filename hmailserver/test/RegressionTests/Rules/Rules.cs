...
namespace RegressionTests.Rules
{
   ...
   public class Rules : TestFixtureBase
   {
      ...
      {
         var account1 = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "replytest-src@test.com", "test");
         var account2 = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "replytest-dst@test.com", "test");
      ...
      {
         var account1 = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "qpwrap-src@test.com", "test");
         var account2 = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "qpwrap-dst@test.com", "test");
